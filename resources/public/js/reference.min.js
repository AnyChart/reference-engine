...
api.search.findFunctions = function(a) {
...
api.search.showGrouped_ = function(a, b, c) {
  ...
  for (var e = $("<ul></ul>"), d = 0;d < a.group.length;d++) {
    var f = a.group[d];
    e.append("<li><a class='item-link' href='/" + version + "/" + f.link + "'>" + b + f["full-name"] + c + "</a></li>");
  }
...
api.search.addToResults_ = function(a, b, c, e, d) {
  if (b.length) {
    ...
    for (d = 0;d < b.length;d++) {
      f = b[d], f.multiple || a.append("<li><a class='item-link' href='/" + version + "/" + f.link + "'>" + c + f["full-name"] + e + "</a></li>");
    }
  }
};
...
api.search.init = function(a) {
  $.get("/" + a + "/data/search.json", api.search.onLoad_);
};
api.resize = {};
