...
goog.object.createImmutableView=function(a){var b=a;Object.isFrozen&&!Object.isFrozen(a)&&(b=Object.create(a),Object.freeze(b));return b};goog.object.isImmutableView=function(a){return!!Object.isFrozen&&Object.isFrozen(a)};goog.math={};goog.math.randomInt=function(a){return Math.floor(Math.random()*a)};goog.math.uniformRandom=function(a,b){return a+Math.random()*(b-a)};goog.math.clamp=function(a,b,c){return Math.min(Math.max(a,b),c)};goog.math.modulo=function(a,b){var c=a%b;return 0>c*b?c+b:c};goog.math.lerp=function(a,b,c){return a+c*(b-a)};goog.math.nearlyEquals=function(a,b,c){return Math.abs(a-b)<=(c||1E-6)};goog.math.standardAngle=function(a){return goog.math.modulo(a,360)};
...
goog.math.Box.prototype.scale=function(a,b){var c=goog.isNumber(b)?b:a;this.left*=a;this.right*=a;this.top*=c;this.bottom*=c;return this};goog.labs={};goog.labs.userAgent={};goog.labs.userAgent.util={};goog.labs.userAgent.util.getNativeUserAgentString_=function(){var a=goog.labs.userAgent.util.getNavigator_();return a&&(a=a.userAgent)?a:""};goog.labs.userAgent.util.getNavigator_=function(){return goog.global.navigator};goog.labs.userAgent.util.userAgent_=goog.labs.userAgent.util.getNativeUserAgentString_();goog.labs.userAgent.util.setUserAgent=function(a){goog.labs.userAgent.util.userAgent_=a||goog.labs.userAgent.util.getNativeUserAgentString_()};
...
goog.style.getCssTranslation=function(a){a=goog.style.getComputedTransform(a);return a?(a=a.match(goog.style.MATRIX_TRANSLATION_REGEX_))?new goog.math.Coordinate(parseFloat(a[1]),parseFloat(a[2])):new goog.math.Coordinate(0,0):new goog.math.Coordinate(0,0)};var app={view:{}},TreeNode=React.createClass({displayName:"TreeNode",getInitialState:function(){return{visible:!1}},getTitle:function(){var a=this.props.node.name;switch(this.props.node.kind){case "namespace":return this.props.node["full-name"];case "enum":return"["+a+"]";case "typedef":return"{"+a+"}";case "function":return a+"()";default:return a}},getLink:function(){var a=goog.array.contains(["namespace","class","typedef","enum"],this.props.node.kind),b=this.props.node["full-name"];a||(a=b.lastIndexOf("."),
b=b.substr(0,a)+"#"+b.substr(a+1));return null!=app.project?"/"+app.project+"/"+app.version+"/"+b:"/"+b},toggleTree:function(a){this.setState({visible:!this.state.visible});return app.loadPage(this.getLink(),a)},render:function(){var a=this.props.node,b=null;if("class"==a.kind||"namespace"==a.kind)b=this.state.visible?React.DOM.i({className:"fa fa-chevron-down"}):React.DOM.i({className:"fa fa-chevron-right"});var c=null;a.children&&this.state.visible&&(c=React.DOM.ul({ref:"list"},goog.array.map(a.children,
function(a){return TreeNode({key:a["full-name"],node:a})})));return React.DOM.li({key:this.props.node["full-name"]},React.DOM.a({href:this.getLink(),onClick:this.toggleTree},b,this.getTitle()),c)}}),TreeView=React.createClass({displayName:"TreeView",render:function(){return React.DOM.ul(null,goog.array.map(this.props.tree,function(a){return TreeNode({key:a["full-name"],node:a})}))}});goog.dom.classes={};goog.dom.classes.set=function(a,b){a.className=b};goog.dom.classes.get=function(a){a=a.className;return goog.isString(a)&&a.match(/\S+/g)||[]};goog.dom.classes.add=function(a,b){var c=goog.dom.classes.get(a),d=goog.array.slice(arguments,1),e=c.length+d.length;goog.dom.classes.add_(c,d);goog.dom.classes.set(a,c.join(" "));return c.length==e};
...
goog.dom.classes.has=function(a,b){return goog.array.contains(goog.dom.classes.get(a),b)};goog.dom.classes.enable=function(a,b,c){c?goog.dom.classes.add(a,b):goog.dom.classes.remove(a,b)};goog.dom.classes.toggle=function(a,b){var c=!goog.dom.classes.has(a,b);goog.dom.classes.enable(a,b,c);return c};goog.events={};goog.events.EventId=function(a){this.id=a};goog.events.EventId.prototype.toString=function(){return this.id};goog.events.Listenable=function(){};goog.events.Listenable.IMPLEMENTED_BY_PROP="closure_listenable_"+(1E6*Math.random()|0);goog.events.Listenable.addImplementation=function(a){a.prototype[goog.events.Listenable.IMPLEMENTED_BY_PROP]=!0};goog.events.Listenable.isImplementedBy=function(a){return!(!a||!a[goog.events.Listenable.IMPLEMENTED_BY_PROP])};goog.events.ListenableKey=function(){};goog.events.ListenableKey.counter_=0;goog.events.ListenableKey.reserveKey=function(){return++goog.events.ListenableKey.counter_};goog.events.Listener=function(a,b,c,d,e,f){goog.events.Listener.ENABLE_MONITORING&&(this.creationStack=Error().stack);this.listener=a;this.proxy=b;this.src=c;this.type=d;this.capture=!!e;this.handler=f;this.key=goog.events.ListenableKey.reserveKey();this.removed=this.callOnce=!1};goog.events.Listener.ENABLE_MONITORING=!1;goog.events.Listener.prototype.markAsRemoved=function(){this.removed=!0;this.handler=this.src=this.proxy=this.listener=null};goog.events.ListenerMap=function(a){this.src=a;this.listeners={};this.typeCount_=0};goog.events.ListenerMap.prototype.getTypeCount=function(){return this.typeCount_};goog.events.ListenerMap.prototype.getListenerCount=function(){var a=0,b;for(b in this.listeners)a+=this.listeners[b].length;return a};
...
DOMATTRMODIFIED:"DOMAttrModified",DOMCHARACTERDATAMODIFIED:"DOMCharacterDataModified"};goog.disposable={};goog.disposable.IDisposable=function(){};goog.Disposable=function(){goog.Disposable.MONITORING_MODE!=goog.Disposable.MonitoringMode.OFF&&(goog.Disposable.INCLUDE_STACK_ON_CREATION&&(this.creationStack=Error().stack),goog.Disposable.instances_[goog.getUid(this)]=this);this.disposed_=this.disposed_;this.onDisposeCallbacks_=this.onDisposeCallbacks_};goog.Disposable.MonitoringMode={OFF:0,PERMANENT:1,INTERACTIVE:2};goog.Disposable.MONITORING_MODE=0;goog.Disposable.INCLUDE_STACK_ON_CREATION=!0;goog.Disposable.instances_={};
...
goog.events.BrowserEvent.prototype.preventDefault=function(){goog.events.BrowserEvent.superClass_.preventDefault.call(this);var a=this.event_;if(a.preventDefault)a.preventDefault();else if(a.returnValue=!1,goog.events.BrowserFeature.SET_KEY_CODE_TO_PREVENT_DEFAULT)try{if(a.ctrlKey||112<=a.keyCode&&123>=a.keyCode)a.keyCode=-1}catch(b){}};goog.events.BrowserEvent.prototype.getBrowserEvent=function(){return this.event_};goog.events.BrowserEvent.prototype.disposeInternal=function(){};goog.events.LISTENER_MAP_PROP_="closure_lm_"+(1E6*Math.random()|0);goog.events.onString_="on";goog.events.onStringMap_={};goog.events.CaptureSimulationMode={OFF_AND_FAIL:0,OFF_AND_SILENT:1,ON:2};goog.events.CAPTURE_SIMULATION_MODE=2;goog.events.listenerCountEstimate_=0;
...
goog.events.wrapListener=function(a){goog.asserts.assert(a,"Listener can not be null.");if(goog.isFunction(a))return a;goog.asserts.assert(a.handleEvent,"An object listener must have handleEvent method.");a[goog.events.LISTENER_WRAPPER_PROP_]||(a[goog.events.LISTENER_WRAPPER_PROP_]=function(b){return a.handleEvent(b)});return a[goog.events.LISTENER_WRAPPER_PROP_]};goog.debug.entryPointRegistry.register(function(a){goog.events.handleBrowserEvent_=a(goog.events.handleBrowserEvent_)});goog.uri={};goog.uri.utils={};goog.uri.utils.CharCode_={AMPERSAND:38,EQUAL:61,HASH:35,QUESTION:63};goog.uri.utils.buildFromEncodedParts=function(a,b,c,d,e,f,g){var h="";a&&(h+=a+":");c&&(h+="//",b&&(h+=b+"@"),h+=c,d&&(h+=":"+d));e&&(h+=e);f&&(h+="?"+f);g&&(h+="#"+g);return h};goog.uri.utils.splitRe_=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#(.*))?$");
...
goog.uri.utils.makeUnique=function(a){return goog.uri.utils.setParam(a,goog.uri.utils.StandardQueryParam.RANDOM,goog.string.getRandomString())};goog.promise={};goog.promise.Resolver=function(){};goog.testing={};goog.testing.watchers={};goog.testing.watchers.resetWatchers_=[];goog.testing.watchers.signalClockReset=function(){for(var a=goog.testing.watchers.resetWatchers_,b=0;b<a.length;b++)goog.testing.watchers.resetWatchers_[b]()};goog.testing.watchers.watchClockReset=function(a){goog.testing.watchers.resetWatchers_.push(a)};goog.functions={};goog.functions.constant=function(a){return function(){return a}};goog.functions.FALSE=goog.functions.constant(!1);goog.functions.TRUE=goog.functions.constant(!0);goog.functions.NULL=goog.functions.constant(null);goog.functions.identity=function(a,b){return a};goog.functions.error=function(a){return function(){throw Error(a);}};goog.functions.fail=function(a){return function(){throw a;}};
...
goog.functions.not=function(a){return function(){return!a.apply(this,arguments)}};goog.functions.create=function(a,b){var c=function(){};c.prototype=a.prototype;c=new c;a.apply(c,Array.prototype.slice.call(arguments,1));return c};goog.functions.CACHE_RETURN_VALUE=!0;goog.functions.cacheReturnValue=function(a){var b=a,c;return function(){if(!goog.functions.CACHE_RETURN_VALUE)return b();b&&(c=b(),b=void 0);return c}};goog.async={};goog.async.throwException=function(a){goog.global.setTimeout(function(){throw a;},0)};goog.async.nextTick=function(a,b){var c=a;b&&(c=goog.bind(a,b));c=goog.async.nextTick.wrapCallback_(c);!goog.isFunction(goog.global.setImmediate)||goog.global.Window&&goog.global.Window.prototype.setImmediate==goog.global.setImmediate?(goog.async.nextTick.setImmediate_||(goog.async.nextTick.setImmediate_=goog.async.nextTick.getSetImmediateEmulator_()),goog.async.nextTick.setImmediate_(c)):goog.global.setImmediate(c)};
...
goog.net.XhrIo.prototype.formatMsg_=function(a){return a+" ["+this.lastMethod_+" "+this.lastUri_+" "+this.getStatus()+"]"};goog.debug.entryPointRegistry.register(function(a){goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_=a(goog.net.XhrIo.prototype.onReadyStateChangeEntryPoint_)});var locker;app.startResize=function(){goog.style.showElement(locker,!0);goog.events.listen(locker,goog.events.EventType.MOUSEMOVE,app.resize)};app.stopResize=function(){goog.style.showElement(locker,!1);goog.events.unlisten(locker,goog.events.EventType.MOUSEMOVE,app.resize)};
app.resize=function(a){a=a.offsetX;229>a&&(a=229);var b=goog.dom.getViewportSize().width;a>b-500&&(a=b-500);goog.style.setStyle(goog.dom.getElement("sidebar"),"width",a+"px");goog.style.setStyle(goog.dom.getElement("main"),"left",a+"px")};app.initResize=function(){locker=goog.dom.getElement("locker");var a=goog.dom.getElement("resizer");goog.events.listen(a,goog.events.EventType.MOUSEDOWN,app.startResize);goog.events.listen(locker,goog.events.EventType.MOUSEUP,app.stopResize)};
app.hideDialogs=function(){goog.style.setElementShown(goog.dom.getElement("version-toggle"),!1);goog.dom.classes.remove(goog.dom.getElement("version-toggler"),"version-toggle")};app.toggleVersions=function(a){var b=goog.dom.getElement("version-toggle"),c=goog.dom.getElement("version-toggler");goog.style.setElementShown(b,!goog.style.isElementShown(b));goog.dom.classes.toggle(c,"version-toggle");a.stopPropagation();return!1};
app.initVersionToggle=function(){var a=goog.dom.getElement("version-toggler");goog.events.listen(a,goog.events.EventType.CLICK,app.toggleVersions)};app.initEditors=function(){var a=goog.dom.getElementsByClass("code-sample");goog.array.map(a,function(a){a=ace.edit(a);a.setTheme("ace/theme/tomorrow");a.setOptions({maxLines:30});a.setReadOnly(!0);a.getSession().setMode("ace/mode/javascript")})};app.project=null;app.version=null;app.page=null;
app.updateLinks=function(){goog.array.map(goog.dom.getElementsByClass("type-link",goog.dom.getElement("content")),function(a){goog.events.listen(a,goog.events.EventType.CLICK,function(b){if(app.loadPage(a.getAttribute("href"),b))return!0;b.preventDefault();b.stopPropagation();return!1})})};app.replacePage=function(a,b){goog.dom.getElement("content").innerHTML=b.content;goog.dom.getElement("current-path").innerHTML=b.page;app.updateLinks();app.initEditors()};
app.loadPage=function(a,b){var c=a;a=a.replace(/#.*/g,"");if(b&&(b.ctrlKey||b.shiftKey||b.metaKey))return!0;if(a==app.page)return-1!=c.indexOf("#");app.page=a;if(history.pushState){goog.dom.getElement("content").innerHTML="Loading...";b&&history.pushState(null,null,a);var d=new goog.net.XhrIo;goog.events.listen(d,"complete",function(b){d.isSuccess()?app.replacePage(a,d.getResponseJson()):console.error(d.getResponseText())});d.send(a+"/json");return!1}return!0};
app.init=function(a,b,c){a&&(app.project=a,app.version=b);app.page=location.pathname;app.initResize();app.initVersionToggle();app.initEditors();app.updateLinks();goog.events.listen(document,goog.events.EventType.CLICK,app.hideDialogs);React.renderComponent(TreeView({tree:c}),document.getElementById("tree"));goog.events.listen(window,goog.events.EventType.POPSTATE,function(a){app.loadPage(document.location.pathname);return!1})};
